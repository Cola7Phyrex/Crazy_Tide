export const GAME_RULE_ARCHIVE = Object.freeze([
  ...
  Object.freeze({
    ...
    title: "基础巡逻遭遇率",
    detail:
      "未探明路线的第一步基础巡逻遭遇率为10%，之后每安全通过一步增加5个百分点。路线情报达到1级后永久跳过巡逻判定。",
  }),
  Object.freeze({
    id: "TRAVEL_TIME",
    category: "远征",
    title: "移动步数与时间",
    detail:
      "默认每块基本地对应1个移动步，每步10秒；路线情报达到1级后每步缩短为4秒。",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    title: "基础渗透暴露率",
    detail:
      "大多数领土每个未致胜渗透周期的基础暴露率为6%，最终暴露率限制在0%至100%。",
  }),
  Object.freeze({
    id: "CONQUEST_DAMAGE",
    category: "征服",
    title: "坚守伤害",
    detail:
      "清除本次现场守军后，基础坚守伤害等于原体蓝图的静态力量乘军团剩余生命。战斗内临时力量通常不计入坚守。",
  }),
  Object.freeze({
    id: "OFFLINE_PROGRESS",
    category: "时间",
